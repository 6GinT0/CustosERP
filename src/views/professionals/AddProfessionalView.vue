...
const { loading, handleCreate, setFieldValue } = useProfessional()
    ...
    <v-card class="border pa-4" flat>
      <v-row class="pa-4">
        ...
        <v-col cols="12">
          ...
          >
            <v-card flat color="transparent">
              ...
              <div v-if="previewUrl" class="d-flex flex-column align-center gap-4 py-4">
                <v-img
                  :src="previewUrl"
                  max-height="300"
                  width="100%"
        ...
        <v-col cols="12" class="d-flex justify-end gap-4 mt-4">
          ...
          <v-btn flat color="primary" class="ml-4" :loading="loading" @click="handleCreate">
            Guardar Profesional
          </v-btn>
        </v-col>
      </v-row>
